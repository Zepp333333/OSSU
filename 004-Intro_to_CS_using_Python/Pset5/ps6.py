...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in string.ascii_lowercase:
            abc[i] = chr((ord(i) - 97 + shift) % 26 + 97)
            abc[i.upper()] = abc[i].upper()
...
class PlaintextMessage(Message):
    ...
    def get_encrypting_dict(self):
        ...
        '''
        return dict(self.build_shift_dict(self.shift))
...
def decrypt_story():
    '''
    Function loads story from file using get_story_string() function
    and decrypts it using decrypt_message() method of CiphertextMessage class
