...
(define tests
  (test-suite
   ...
   (check-equal? (sequence 5 1 1)  null "Sequence test")
   (check-equal? (sequence 3 5 1) (list 3 4 5) "Sequence test")
   (check-equal? (sequence 3 5 2) (list 3 5) "Sequence test")
   (check-equal? (sequence 3 5 3) (list 3) "Sequence test")
   ...
   (check-equal? (string-append-map (list "" "" "") ".jpg") '( ".jpg"  ".jpg"  ".jpg") "string-append-map test")
   ...
   (check-equal? (list-nth-mod (list 0 1 2 3 ) 4) 0 "list-nth-mod test")
