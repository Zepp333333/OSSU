...
def isValidWord(word, hand, wordList):
    ...
    h = hand.copy()   # copy of hand to avoid mutation
    try:
        for c in word:
            if h[c] > 0:
                h[c] -= 1
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):        
            ...
            # Otherwise (the word is valid):
                ...
                scoreTotal += score
                print('\"' + word + '\"' + ' earned ' + str(score) + ' points. Total: ' + str(scoreTotal) + ' points.')
                print ()
                # Update the hand 
...
def playGame(wordList):
    ...
    hand = {}
    while True:
        g_input = input ('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
