...
class LineSegment < GeometryValue
  ...
  def intersectWithSegmentAsLineResult seg
    if real_close(self.x1,self.x2) # Segments on vertical line
      if self.y1 < seg.y1
        a = self
        b = seg
      else
      ...
      if real_close(a.y2,b.y1) # Just touching
        Point.new(a.x2,a.y2)
      elsif a.y2 < b.y1 # Disjoint
        NoPoints.new()
      elsif a.y2 > b.y2 # b inside a
      ...
      if real_close(a.x2,b.x1) # Just touching
        Point.new(a.x2,a.y2)
      elsif a.x2 < b.x1 # Disjoint
        NoPoints.new()
      elsif a.x2 > b.x2 # b inside a
        LineSegment.new(b.x1,b.y1,b.x2,b.y2)
      else # Overlapping
        LineSegment.new(b.x1,b.y1,a.x2,a.y2)
      end
