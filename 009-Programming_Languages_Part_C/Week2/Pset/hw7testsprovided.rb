...
d6 = d.intersect(VerticalLine.new(-ONE))
print d6.x, d6.y, "\n"
d7 = VerticalLine.new(-ONE).intersect(d)
print d7.x, d7.y, "\n"
...
i = Intersect.new(d, NoPoints.new)
i1 = i.preprocess_prog.eval_prog([])
print "1 ", i1, "\n"
i = Intersect.new(d, Point.new(ZERO,ZERO))
i1 = i.preprocess_prog.eval_prog([])
print "2 ", i1, "\n"
i = Intersect.new(d, Point.new(-ONE,-ONE))
i1 = i.preprocess_prog.eval_prog([])
print "3, ", i1, "\n"
i = Intersect.new(d, Line.new(ZERO,ONE))
i1 = i.preprocess_prog.eval_prog([])
print "4, ", i1, "\n"
i = Intersect.new(Line.new(ZERO,ONE), d)
i1 = i.preprocess_prog.eval_prog([])
print "5, ", i1, "\n"
i = Intersect.new(Line.new(ZERO,ZERO), LineSegment.new(-TWO, -TWO, -ONE, -ONE))
i1 = i.preprocess_prog.eval_prog([])
print "6, ", i1, "\n"
i = Intersect.new(VerticalLine.new(ONE), LineSegment.new(ONE, FIVE, ONE, -ONE))
i1 = i.preprocess_prog.eval_prog([])
print "7, ", i1, "\n"
